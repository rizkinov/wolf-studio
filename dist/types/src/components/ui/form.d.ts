...
declare function FormLabel({ className, ...props }: React.LabelHTMLAttributes<HTMLLabelElement>): React.JSX.Element;
declare function FormControl({ className, ...props }: React.HTMLAttributes<HTMLDivElement>): React.JSX.Element;
