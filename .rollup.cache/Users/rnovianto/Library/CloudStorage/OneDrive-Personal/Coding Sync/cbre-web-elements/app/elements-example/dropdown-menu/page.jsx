...
import { CBREDropdownMenu } from '@/components/cbre-dropdown-menu';
...
export default function DropdownMenuPage() {
    ...
    const checkboxItems = [
        { type: "label", label: "Selection Options" },
        {
            ...
            onCheckedChange: (checked) => setCheckedItems(Object.assign(Object.assign({}, checkedItems), { item1: checked }))
        },
        {
            type: "checkbox",
            label: "Option 2",
            checked: checkedItems.item2,
            onCheckedChange: (checked) => setCheckedItems(Object.assign(Object.assign({}, checkedItems), { item2: checked }))
        },
        {
            type: "checkbox",
            label: "Option 3",
            checked: checkedItems.item3,
            onCheckedChange: (checked) => setCheckedItems(Object.assign(Object.assign({}, checkedItems), { item3: checked }))
        },
    ];
    // Radio menu items
    const radioItems = [
          ...
          <div>
            ...
            <div className="bg-[var(--lighter-grey)] p-8">
              <div className="flex items-center gap-6">
                <div className="w-48">
                  <CBREDropdownMenu trigger="File Actions" items={basicItems}/>
                </div>
...
/>`}
          ...
          <div>
            ...
            <div className="bg-[var(--lighter-grey)] p-8">
              <div className="flex items-center gap-6">
                <div className="w-48">
                  <CBREDropdownMenu trigger="Selection Options" items={checkboxItems}/>
                </div>
                <div className="text-sm text-dark-grey">
...
/>`}
          ...
          <div>
            ...
            <div className="bg-[var(--lighter-grey)] p-8">
              <div className="flex items-center gap-6">
                <div className="w-48">
                  <CBREDropdownMenu trigger="Size Selection" items={radioItems} radioValue={selectedSize} onRadioValueChange={setSelectedSize}/>
                </div>
                <div className="text-sm text-dark-grey">
...
/>`}
          ...
          <div>
            ...
            <div className="bg-[var(--lighter-grey)] p-8">
              <div className="flex items-center gap-6">
                <div className="w-48">
                  <CBREDropdownMenu trigger="Menu with Submenus" items={submenuItems}/>
                </div>
                <div className="text-sm text-dark-grey">
          ...
          <div>
            ...
            <div className="bg-[var(--lighter-grey)] p-8">
              <div className="flex items-center gap-6">
                <div>
                  <CBREDropdownMenu trigger={<CBREButton variant="primary" className="flex items-center gap-2">
                        <Settings className="h-4 w-4"/>
                        Settings
                      </CBREButton>} items={combinedItems} align="end"/>
                </div>
                <div className="text-sm text-dark-grey">
