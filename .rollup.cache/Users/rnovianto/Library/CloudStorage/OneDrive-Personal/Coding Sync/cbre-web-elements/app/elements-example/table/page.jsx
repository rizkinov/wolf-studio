...
import { CBRETable, CBRETableBody, CBRETableCaption, CBRETableCell, CBRETableFooter, CBRETableHead, CBRETableHeader, CBRETableRow, } from "@/components/cbre-table";
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-4xl mx-auto">
              <CBRETable>
                ...
                <CBRETableBody>
                  {invoiceData.map((invoice) => (<CBRETableRow key={invoice.invoice}>
                      <CBRETableCell>{invoice.invoice}</CBRETableCell>
                      <CBRETableCell>
                        <CBREBadge variant={invoice.paymentStatus === "Paid"
                ? "success"
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-4xl mx-auto">
              <CBRETable>
                ...
                <CBRETableBody>
                  {propertyData.map((property) => (<CBRETableRow key={property.id}>
                      ...
                      <CBRETableCell>
                        <CBREBadge variant={property.status === "Active"
                ? "success"
