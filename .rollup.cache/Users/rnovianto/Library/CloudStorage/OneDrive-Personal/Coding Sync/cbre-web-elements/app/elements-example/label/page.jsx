            ...
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="space-y-6">
                <div className="grid w-full gap-1.5">
                  ...
                  <Input id="basic-input" type="email" placeholder="name@example.com"/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="space-y-8">
                ...
                <div className="grid w-full gap-1.5">
                  ...
                  <Textarea id="bio-textarea" placeholder="Tell us about yourself" rows={3}/>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="terms-checkbox" checked={checkboxChecked} onCheckedChange={(checked) => setCheckboxChecked(checked)}/>
                  <Label htmlFor="terms-checkbox" className="text-base cursor-pointer">
            ...
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="space-y-8">
                ...
                <div className="grid w-full gap-1.5 opacity-50">
                  ...
                  <Input id="disabled-input" type="text" placeholder="This field is disabled" disabled/>
                </div>
              </div>
            </div>
          </div>
