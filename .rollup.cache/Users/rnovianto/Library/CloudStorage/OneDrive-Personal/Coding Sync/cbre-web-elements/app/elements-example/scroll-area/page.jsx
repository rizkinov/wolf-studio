                  ...
                  <CardContent className="p-4">
                    <ScrollArea className="h-72 rounded-md">
                      <div className="p-4">
                        ...
                        {tags.map((tag) => (<div key={tag} className="text-sm py-2 border-b">
                            {tag}
                          </div>))}
                      </div>
                  ...
                  <CardContent className="p-4">
                    <ScrollArea className="w-full whitespace-nowrap rounded-md">
                      <div className="flex w-max space-x-4 p-4">
                        {Array.from({ length: 15 }).map((_, i) => (<div key={i} className="w-40 h-40 flex items-center justify-center rounded-md border">
                            Item {i + 1}
                          </div>))}
                      </div>
