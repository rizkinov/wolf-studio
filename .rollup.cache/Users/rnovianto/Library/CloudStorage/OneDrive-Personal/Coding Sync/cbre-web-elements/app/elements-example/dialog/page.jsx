...
import { Settings, User, CreditCard, Mail, BellRing, Loader2 } from "lucide-react";
                    ...
                    <DialogContent>
                      ...
                      <div className="grid gap-4 py-4">
                        <div className="flex items-start space-x-2">
                          <Checkbox id="notifications-email" className="mt-1" defaultChecked/>
                          <Label htmlFor="notifications-email" className="text-sm font-calibre text-dark-grey cursor-pointer">
                            Email notifications
                          </Label>
                        </div>
                        <div className="flex items-start space-x-2">
                          <Checkbox id="notifications-push" className="mt-1" defaultChecked/>
                          <Label htmlFor="notifications-push" className="text-sm font-calibre text-dark-grey cursor-pointer">
                            Push notifications
                          </Label>
                        </div>
                        <div className="flex items-start space-x-2">
                          <Checkbox id="notifications-sms" className="mt-1"/>
                          <Label htmlFor="notifications-sms" className="text-sm font-calibre text-dark-grey cursor-pointer">
                            SMS notifications
                          </Label>
                        </div>
                      </div>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                      ...
                      <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                          ...
                          <Input id="email" type="email" placeholder="your@email.com" className="col-span-3" value={email} onChange={(e) => setEmail(e.target.value)}/>
                        </div>
                      </div>
                      <DialogFooter>
                        <DialogClose asChild>
                        ...
                        <Button type="submit" onClick={handleSubscribe} disabled={loading || !email}>
                          {loading ? (<>
