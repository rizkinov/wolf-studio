            ...
            <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
              <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto space-y-10">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-center gap-4">
                    <CBRETooltip content="Aligned to start" align="start" side="bottom">
                      <Button variant="outline">Start Aligned</Button>
                    </CBRETooltip>
                    <CBRETooltip content="Centered alignment (default)" align="center" side="bottom">
                      <Button variant="outline">Center Aligned</Button>
                    </CBRETooltip>
                    <CBRETooltip content="Aligned to end" align="end" side="bottom">
