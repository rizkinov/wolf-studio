        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <Input type="text" placeholder="Enter some text" value={inputValue} onChange={handleInputChange}/>
...
`}
        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="grid w-full gap-1.5">
                <Label htmlFor="disabled-input" className="text-dark-grey opacity-50">
                  Disabled Input
                </Label>
                <Input type="text" id="disabled-input" value="This input cannot be edited" disabled/>
              </div>
            </div>
          </div>
            ...
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="space-y-4">
                <div className="grid w-full gap-1.5">
                  ...
                  <Input type="text" id="text-input" placeholder="Regular text"/>
                </div>
                ...
                <div className="grid w-full gap-1.5">
                  ...
                  <Input type="number" id="number-input" placeholder="123"/>
                </div>
                
                <div className="grid w-full gap-1.5">
                  <Label htmlFor="date-input">Date Input</Label>
                  <CBREDatePicker date={date} setDate={setDate}/>
                </div>
              </div>
            </div>
          </div>
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="grid w-full gap-1.5">
                    ...
                    <Input type="text" id="firstName" name="firstName" placeholder="John" value={formState.firstName} onChange={handleFormChange}/>
                  </div>
                  
                  <div className="grid w-full gap-1.5">
                    <Label htmlFor="lastName">Last Name</Label>
                    <Input type="text" id="lastName" name="lastName" placeholder="Doe" value={formState.lastName} onChange={handleFormChange}/>
                  </div>
                </div>
                
                <div className="grid w-full gap-1.5">
                  <Label htmlFor="formEmail">Email</Label>
                  <Input type="email" id="formEmail" name="email" placeholder="john.doe@example.com" value={formState.email} onChange={handleFormChange}/>
                </div>
                
                <div className="grid w-full gap-1.5">
                  <Label htmlFor="formPassword">Password</Label>
                  <Input type="password" id="formPassword" name="password" placeholder="Enter your password" value={formState.password} onChange={handleFormChange}/>
                </div>
                ...
                <div className="flex gap-4 justify-end">
                  ...
                  <CBREButton variant="primary" type="button" disabled={!formState.firstName ||
            !formState.lastName ||
            !formState.email ||
            !formState.password}>
                    Submit
