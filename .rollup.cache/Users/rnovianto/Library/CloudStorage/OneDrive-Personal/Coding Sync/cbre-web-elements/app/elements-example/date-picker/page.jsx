          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto space-y-6">
              <div className="space-y-2">
                ...
                {date && (<p className="mt-4 text-sm text-dark-grey text-center">
        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-3xl mx-auto space-y-6">
              <div className="space-y-2">
                ...
                <div className="flex justify-center">
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="outline" className={cn("w-[300px] justify-start text-left font-normal", !(dateRange === null || dateRange === void 0 ? void 0 : dateRange.from) && "text-muted-foreground")}>
                        <CalendarIcon className="mr-2 h-4 w-4"/>
                        {(dateRange === null || dateRange === void 0 ? void 0 : dateRange.from) ? (dateRange.to ? (<>
                              {formatDate(dateRange.from)} - {formatDate(dateRange.to)}
                            </>) : (formatDate(dateRange.from))) : ("Select a date range")}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto md:w-[500px] lg:w-[500px] p-0" align="start">
                      <div className="p-2">
                        <Calendar mode="range" selected={dateRange} onSelect={setDateRange} numberOfMonths={isMobile ? 1 : 2} initialFocus className="mx-auto" classNames={{
            ...
            day: "h-8 w-8 p-0 font-normal"
                ...
                {(dateRange === null || dateRange === void 0 ? void 0 : dateRange.from) && (<p className="mt-4 text-sm text-dark-grey text-center">
                    {dateRange.to ? (<>
              ...
              <div className="space-y-2">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant="outline" className={cn("w-full md:w-[240px] justify-start text-left font-normal", !formDate && "text-muted-foreground")}>
                          <CalendarIcon className="mr-2 h-4 w-4"/>
                          {formDate ? formatDate(formDate) : "Select a date"}
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar mode="single" selected={formDate} onSelect={setFormDate} disabled={[
            { before: new Date() }, // Disable past dates
        ]} initialFocus/>
                      </PopoverContent>
                    </Popover>
                    {!formDate && formSubmitted && (<p className="text-sm text-destructive">Please select a date</p>)}
                  </div>
