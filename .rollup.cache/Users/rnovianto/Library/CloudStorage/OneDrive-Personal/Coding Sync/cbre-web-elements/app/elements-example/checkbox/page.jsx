            ...
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div>
                <div className="flex items-start space-x-2">
                  <Checkbox id="terms-checkbox" className="mt-1" checked={acceptTerms} onCheckedChange={handleCheckedChange}/>
                  <Label htmlFor="terms-checkbox" className="text-sm font-calibre text-dark-grey cursor-pointer">
...
`}
        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="flex items-start space-x-2">
                <Checkbox id="terms-with-desc" className="mt-1" checked={acceptTerms} onCheckedChange={handleCheckedChange}/>
                <div className="grid gap-0.5">
                  <Label htmlFor="terms-with-desc" className="text-sm font-calibre text-dark-grey cursor-pointer">
                    Accept terms and conditions
                  </Label>
...
`}
        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <div className="flex items-start space-x-2">
                <Checkbox id="disabled-checkbox" className="mt-1" disabled/>
                <Label htmlFor="disabled-checkbox" className="text-sm font-calibre text-dark-grey opacity-50 cursor-not-allowed">
                  Accept terms and conditions
                </Label>
              </div>
            </div>
...
`}
        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <CheckboxGroup title="Newsletter preferences" description="Select the types of newsletters you'd like to receive">
                <div className="flex items-start space-x-2">
                  <Checkbox id="updates-checkbox" className="mt-1" checked={newsletterOptions.updates} onCheckedChange={(checked) => setNewsletterOptions(prev => (Object.assign(Object.assign({}, prev), { updates: checked === true })))}/>
                  <div className="grid gap-0.5">
                    <Label htmlFor="updates-checkbox" className="text-sm font-calibre text-dark-grey">
                      Product updates
                    </Label>
                    <p className="text-xs font-calibre text-light-grey">
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox id="marketing-checkbox" className="mt-1" checked={newsletterOptions.marketing} onCheckedChange={(checked) => setNewsletterOptions(prev => (Object.assign(Object.assign({}, prev), { marketing: checked === true })))}/>
                  <div className="grid gap-0.5">
                    <Label htmlFor="marketing-checkbox" className="text-sm font-calibre text-dark-grey">
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox id="partner-checkbox" className="mt-1" checked={newsletterOptions.partner} onCheckedChange={(checked) => setNewsletterOptions(prev => (Object.assign(Object.assign({}, prev), { partner: checked === true })))}/>
                  <div className="grid gap-0.5">
                    <Label htmlFor="partner-checkbox" className="text-sm font-calibre text-dark-grey">
                      Partner offers
                    </Label>
                    <p className="text-xs font-calibre text-light-grey">
...
`}
        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <CheckboxGroup title="Sidebar" description="Select the items you want to display in the sidebar">
                <div className="grid md:grid-cols-2 gap-4">
                  {Object.entries(sidebarItems).map(([key, value]) => (<div key={key} className="flex items-center space-x-2">
                      <Checkbox id={`${key}-checkbox`} checked={value} onCheckedChange={(checked) => setSidebarItems(prev => (Object.assign(Object.assign({}, prev), { [key]: checked === true })))}/>
                      <Label htmlFor={`${key}-checkbox`} className="text-sm font-calibre text-dark-grey">
