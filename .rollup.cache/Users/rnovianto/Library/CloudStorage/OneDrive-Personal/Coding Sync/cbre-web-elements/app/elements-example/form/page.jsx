        ...
        <div className="mb-16">
          ...
          <div className="bg-[var(--lighter-grey)] p-4 md:p-8">
            <div className="border border-light-grey bg-white p-8 max-w-2xl mx-auto">
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField control={form.control} name="message" render={({ field }) => (<FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Please describe how we can help you..." rows={5} {...field}/>
                        </FormControl>
                        <FormDescription>
                  ...
                  <FormField control={form.control} name="acceptTerms" render={({ field }) => (<FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                  ...
                  <FormField control={form.control} name="marketingConsent" render={({ field }) => (<FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md">
                        <FormControl>
                          <Checkbox id="marketingConsent" checked={field.value} onCheckedChange={field.onChange} className="mt-1"/>
                        </FormControl>
                        <div className="space-y-1 leading-none">
                  ...
                  <div className="flex justify-end">
                    <CBREButton type="submit" variant="primary" disabled={isSubmitting}>
              ...
              {submittedData && (<div className="mt-8 p-4 border border-accent-green rounded bg-accent-green/10">
