...
export function CBREButton({
  ...
  const getButtonStyles = () => {
    switch (variant) {
      ...
      case "outline":
        return cn("border-cbre-green text-cbre-green hover:bg-accent-green hover:text-cbre-green hover:border-transparent transition-colors duration-300", className);
      case "accent":
